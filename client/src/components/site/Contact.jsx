    ...
    <section id="contact" className="bg-foreground py-24 text-background md:py-32">
      <div className="mx-auto grid max-w-7xl gap-16 px-6 md:grid-cols-2 md:items-center">
        ...
        >
          ...
          <h2 className="mt-4 font-serif text-4xl sm:text-6xl">With me</h2>
          <span className="gold-rule mt-6 block" />

          <p className="mt-8 max-w-md leading-relaxed text-background/70">
            Commissions are accepted for a limited number of weddings and editorial projects each year. Reach out — I read every message personally.
          </p>
