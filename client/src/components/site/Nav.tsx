  ...
  return (
    ...
    >
      <div className="mx-auto grid max-w-7xl grid-cols-[1fr_auto_1fr] items-center gap-4 px-6 py-5 md:py-6">
        <a href="#contact" aria-label="Email" className="justify-self-start text-foreground/80 hover:text-[var(--gold)] transition">
          <Mail className="h-5 w-5" />
        </a>
        <a href="#top" className="justify-self-center font-serif text-lg tracking-[0.35em] text-foreground">
          OMKAR CHAVAN
        </a>
        <button
        ...
        {open && (
          ...
          >
            <div className="flex items-center justify-between px-6 py-5 md:py-6">
              <span className="font-serif text-lg tracking-[0.35em]">OMKAR CHAVAN</span>
