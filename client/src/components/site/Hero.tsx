...
export function Hero() {
  ...
  return (
    <section id="top" className="relative h-[100svh] w-full overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center text-white">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <p className="mt-5 text-base font-light text-white/85 sm:text-lg">
              {slide.subtitle}
            </p>
          </motion.div>
        </AnimatePresence>
        ...
        >
          <a
            href="#portfolio"
            className="border border-white/80 px-8 py-3.5 text-xs tracking-[0.3em] uppercase text-white transition hover:bg-white hover:text-foreground"
          >
            View Portfolio
          </a>
          <a
            href="#contact"
            className="bg-[var(--gold)] px-8 py-3.5 text-xs tracking-[0.3em] uppercase text-white transition hover:bg-[var(--gold-soft)]"
          >
            Book a Session
          </a>
        </motion.div>
      ...
      {/* Tiny photographer credit ribbon */}
