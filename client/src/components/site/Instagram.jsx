  ...
  return (
    <section className="py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-6 text-center">
        ...
        <a href="#" className="mt-10 inline-flex items-center gap-3 border-b border-[var(--gold)] pb-1 text-xs tracking-[0.3em] uppercase text-foreground hover:text-[var(--gold)]">
