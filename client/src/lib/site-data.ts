...
// Image URLs use Unsplash CDN (free, hotlink-allowed) for fast load + curation quality.
...
export const portfolio = [
  { id: 1, category: "Weddings", image: u("photo-1519741497674-611481863552", 800), h: "tall" },
  { id: 2, category: "Portraits", image: u("photo-1524504388940-b1c1722653e1", 800), h: "short" },
  { id: 3, category: "Events", image: u("photo-1492684223066-81342ee5ff30", 800), h: "medium" },
  { id: 4, category: "Commercial", image: u("photo-1441986300917-64674bd600d8", 800), h: "tall" },
  { id: 5, category: "Products", image: u("photo-1505740420928-5e560c06d30e", 800), h: "medium" },
  { id: 6, category: "Weddings", image: u("photo-1606800052052-a08af7148866", 800), h: "tall" },
  { id: 7, category: "Portraits", image: u("photo-1488161628813-04466f872be2", 800), h: "medium" },
  { id: 8, category: "Events", image: u("photo-1464366400600-7168b8af9bc3", 800), h: "short" },
  { id: 9, category: "Commercial", image: u("photo-1483985988355-763728e1935b", 800), h: "tall" },
  { id: 10, category: "Products", image: u("photo-1523275335684-37898b6baf30", 800), h: "short" },
  { id: 11, category: "Weddings", image: u("photo-1583939003579-730e3918a45a", 800), h: "medium" },
  { id: 12, category: "Portraits", image: u("photo-1494790108377-be9c29b29330", 800), h: "tall" },
] as const;
...
export const testimonials = [
  ...
  },
  {
    ...
    quote: "I have never felt so seen in front of a camera. The portraits are heirlooms.",
  },
  {
    name: "Maison Lyra",
    ...
    quote: "Editorial caliber, delivered ahead of schedule. We have not worked with anyone better.",
  },
];
...
export const whyChoose = [
  ...
  { title: "Premium Editing", desc: "Every frame hand-graded — never batch-processed." },
  {
    title: "Fast Delivery",
    desc: "Sneak peeks within 48 hours; full galleries within four weeks.",
  },
  { title: "Drone Coverage", desc: "Licensed aerial cinematography included where permitted." },
  {
